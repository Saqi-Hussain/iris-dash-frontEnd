  ...
  <div
    ...
    <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
      ...
      <div class="mt-4">
        ...
        <div class="mt-6.5">
          <h4 class="mb-3.5 font-medium text-black dark:text-white">Follow us on</h4>
          <div class="flex items-center justify-center gap-3.5">
            <a href="https://www.facebook.com/iriscommunicationspk" target="_blank" class="hover:text-primary" name="social-icon"
            ...
            <a href="https://x.com/iriscomm1" target="_blank" class="hover:text-primary" name="social-icon" aria-label="social-icon">
              <svg class="fill-current" width="23" height="22" viewBox="0 0 23 22" fill="none"
                xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://www.linkedin.com/company/iris-communications-pakistan" target="_blank" class="hover:text-primary"
            ...
            <a href="https://www.instagram.com/iris_pakistan/%20" target="_blank" class="hover:text-primary" name="social-icon"
              aria-label="social-icon">
              <svg class="fill-current" width="22" height="22" viewBox="0 0 22 22" fill="none"
                xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://www.youtube.com/@iris-pakistan" target="_blank" class="hover:text-primary" name="social-icon" aria-label="social-icon">


              <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 24 24">
                <path fill="currentColor"
                  d="M6 20v-2h12v2Zm-2-3q-.825 0-1.412-.587Q2 15.825 2 15V6q0-.825.588-1.412Q3.175 4 4 4h16q.825 0 1.413.588Q22 5.175 22 6v9q0 .825-.587 1.413Q20.825 17 20 17Zm6-3l5.5-3.5L10 7Z">
                </path>
              </svg>
