...
const handlesubmit = async () => {
  ...
  try {
    ...
    toast.success('Login Successfully', {  timeout: 1500,
        closeOnClick: true,
    ...
    if (error.response && error.response.data.message === 'Invalid credentials') {
      toast.error('Your Credentials are Invalid', {  timeout: 1500,
        closeOnClick: true,
        pauseOnFocusLoss: true,
        pauseOnHover: false,
        draggable: true,
      ...
      toast.error('Error in login in', {  timeout: 1500,
        closeOnClick: true,
        pauseOnFocusLoss: true,
        pauseOnHover: false,
        draggable: true,
  ...
  <div class="flex items-center justify-center min-h-screen p-6 bg-gray-50 dark:bg-gray-900">
    <DefaultAuthCard title="Sign In to Bank Alfalah">
      <form>
        ...
        <div class="mb-5 mt-6">
          <button type="submit" @click.prevent="handlesubmit" value="Sign In"
